...
const EquipoSchema = new mongoose.Schema({
  ...
  codigoequipo: { type: String, required: true, unique: true },
  descripcionequipo: { type: String, required: true },
  cantidadequipo: { type: String, required: true },
...
module.exports = mongoose.model('equipocreate', EquipoSchema);