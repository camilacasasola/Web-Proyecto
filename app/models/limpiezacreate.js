...
const LimpiezaSchema = new mongoose.Schema({
  ...
  codigolimpieza: { type: String, required: true, unique: true },
  descripcionlimpieza: { type: String, required: true },
  codigorestaurante: { type: String, required: true },
  cantidadlimpieza: { type: String, required: true },
});
...
module.exports = mongoose.model('limpiezacreate', LimpiezaSchema);