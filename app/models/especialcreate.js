...
const especialSchema = new mongoose.Schema({
  ...
  codigoespecial: { type: String, required: true, unique: true },
  descripcionespecial: { type: String, required: true }
});
...
module.exports = mongoose.model('especialcreate', especialSchema);