...
const PlatilloSchema = new mongoose.Schema({
  ...
  codigoplatillo: { type: String, required: true, unique: true },
  precioplatillo: { type: String, required: true },
  nombreplatillo: { type: String, required: true },
  ingredienteplatillo: { type: String, required: true },
  descripcionplatillo: { type: String, required: true }
});
...
module.exports = mongoose.model('platillocreate', PlatilloSchema);